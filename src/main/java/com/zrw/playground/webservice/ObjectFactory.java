 ...
 * generated in the com.zrw.playground.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _Test_QNAME = new QName("http://webservice.playground.zrw.com/", "test");
    private final static QName _TestResponse_QNAME = new QName("http://webservice.playground.zrw.com/", "testResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.zrw.playground.webservice
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://webservice.playground.zrw.com/", name = "test")
     ...
     */
    @XmlElementDecl(namespace = "http://webservice.playground.zrw.com/", name = "testResponse")
